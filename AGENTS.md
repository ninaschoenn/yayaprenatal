# Yaya Prenatal Website — Codex Instructions
...
## Project Structure (for Codex, not for Nina)
...
## How Things Work (for Codex to explain to Nina)
...
## Deployment Details (for Codex, not for Nina)
